...
class Bridge:
    ...
    def split_beam(self, beam, x, y):
        ...
        self.add_beam_direct(beam.node_a, new_node, old_type)
        self.add_beam_direct(new_node, beam.node_b, old_type)
    ...
    def split_beam_with_node(self, beam, node):
        ...
        self.beams.remove(beam)
        self.add_beam_direct(beam.node_a, node, old_type)
        self.add_beam_direct(node, beam.node_b, old_type)
